...
#pragma warning disable RCS1158 // Static member in generic type should use a type parameter.
    ...
    public static void RestoreTradeStarting(DiscordSocketClient discord)
    {
        ...
        LogUtil.LogInfo("Notificación de inicio de intercambio añadida al/los canal(es) de Discord al iniciar el bot.", "Discord");
    }
...
#pragma warning restore CS8602 // Dereference of a possibly null reference.
            ...
            // Si es Mystery Egg o Mystery Trade -> usar la imagen fija
            ...
            {
                // Comportamiento existente para otros tipos
                ...
                if (detail.TradeData != null
                    && detail.Type != PokeTradeType.Clone
                    && detail.Type != PokeTradeType.Dump
                    && detail.Type != PokeTradeType.Seed
                    && detail.Type != PokeTradeType.FixOT)
                {
...
#pragma warning restore CS8602 // Dereference of a possibly null reference.
            ...
            else
            {
                ...
                embedImageUrl = detail.IsMysteryTrade ? "https://i.imgur.com/FdESYAv.png" : detail.IsMysteryEgg ? GetMysteryEggTypeImageUrl((T)detail.TradeData) : detail.Type switch
                {
